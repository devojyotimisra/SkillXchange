        ...
        <div className="container px-4 md:px-6">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
            <div className="space-y-4">
              <h2 className="text-3xl font-bold">Why SkillXchange?</h2>
              <p className="text-muted-foreground">
                SkillXchangeping creates meaningful connections and allows you to learn in a personalized way.
            ...
            <div className="flex items-center justify-center">
              <div className="rounded-lg bg-gray-200 p-8">
                <blockquote className="italic">
                  "SkillXchange helped me learn photography from a pro, and in return, I taught them how to code. It's an amazing way to grow your skills!"
                </blockquote>
